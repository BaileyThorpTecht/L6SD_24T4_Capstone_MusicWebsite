...
urlpatterns = [
    ...
    path('account_settings', views.accountSettings, name='account-settings'),
    ...
    path('reset/done/', auth_views.PasswordResetCompleteView.as_view(template_name="reset-password-complete.html"), name="reset-password-complete"),
